<script lang="ts">
	...
	async function loadPrime() {
		...
		lowQ = Boolean(currentPrime && typeof(currentPrime) != 'number' && currentPrime.q && currentPrime.q < 18446744073709551616n);
	}
		...
		{#if Ndisplay == errorString}
			<div class="info-div">
				...
				<span class="prime-info-container">
					...
					<span class="info"> It appears that you arrived at an invalid page. </span>
				</span>
			</div>
		{/if}
		{#if typeof currentPrime == 'number'}
