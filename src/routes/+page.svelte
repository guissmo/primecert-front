        ...
        <div class="sub-content list-content">
          <div class="prime-list">
            ...
            {#each recentlyNamed as item}
              <p>
                <a
                  href={`/prime/${item.slug}`}
                  style={`--color: ${highlightColors[Math.floor(Math.random() * highlightColors.length)]}`}
                  class="clickable-prime">{item.name}</a
                >
              </p>
            {/each}
          </div>
            ...
            {#each unnamed as item}
              <p>
                <a
                  href={`/prime/${item.n}`}
                  style={`--color: ${highlightColors[Math.floor(Math.random() * highlightColors.length)]}`}
                  class="clickable-prime"
                  >{item.n.substring(0, 5)}... ...{item.n.substring(
                    item.n.length - 5,
                    item.n.length,
                  )}</a
                >
